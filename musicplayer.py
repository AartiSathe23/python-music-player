...
class Player:
    def __init__(self,root):
      ...
      #   Menu_image_resized = Menu_image.resize((360, 180), ImageFilter.LANCZOS)
      #   Menu = ImageTk.PhotoImage(Menu_image_resized)
      ...
      #   self.total_duration_label.place(x=340, y=195)
        ...
        exit_button=Button(self.root,text="Exit",font=("Arial",12,"bold"),bg="gray35",fg="gold",bd=2,relief=RIDGE,width=20,command=self.Exit,cursor="hand2")
